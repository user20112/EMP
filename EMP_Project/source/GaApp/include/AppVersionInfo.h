/**
 * @file AppVersionInfo.h
 * @short contain definition of class \c AppVersionInfo
 *
 ...
 * -------------------
 * $Revision: 29111 $
 * $HeadURL: https://app-aug-svn01.aug.osram.de/svn/aug-sw/TASKS/SOFTWARE/LIBS/CPP/Gamma_Applications/DemoApp/trunk/include/AppVersionInfo.h $
 * $Author: S.Hegemann $
 * $Date: 2014-11-20 11:46:22 +0100 (Do, 20 Nov 2014) $
 *
 */

#ifndef APPLICATIONS_GAAPP_INCLUDE_APPVERSIONINFO_H_
#define APPLICATIONS_GAAPP_INCLUDE_APPVERSIONINFO_H_

// System header
#include <string>

/**
 * @short class contains application informations and SVN repository settings
 *
 * @remark
 * this class is a singelton class. Use static method \c AppVersionInfo::getInstance() to get access to the
...
class AppVersionInfo
{
    ...
    private:
         ...
         */
        AppVersionInfo(AppVersionInfo& _other) = delete;
         ...
         */
        AppVersionInfo&
        operator =(const AppVersionInfo& _other) = delete;

        std::string mApplicationName;   ///< @short name of application
...
#endif /* APPLICATIONS_GAAPP_INCLUDE_APPVERSIONINFO_H_ */
