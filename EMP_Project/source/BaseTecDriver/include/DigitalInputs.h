...
#ifndef SOURCE_BASETECDRIVER_INCLUDE_DIGITALINPUTS_H_
#define SOURCE_BASETECDRIVER_INCLUDE_DIGITALINPUTS_H_
...
#endif /* SOURCE_BASETECDRIVER_INCLUDE_DIGITALINPUTS_H_ */
