...
#ifndef SOURCE_BASETECDRIVER_INCLUDE_HARDWARECTRL_H_
#define SOURCE_BASETECDRIVER_INCLUDE_HARDWARECTRL_H_
...
#endif /* SOURCE_BASETECDRIVER_INCLUDE_HARDWARECTRL_H_ */
