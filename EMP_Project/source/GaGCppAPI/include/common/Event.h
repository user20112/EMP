 ...
 *
 */
#ifndef CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENT_H_
#define CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENT_H_
...
#endif /* CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENT_H_ */
