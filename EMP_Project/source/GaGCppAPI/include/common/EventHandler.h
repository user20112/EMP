 ...
 *
 */
#ifndef SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENTHANDLER_H_
#define SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENTHANDLER_H_
...
#endif /* SOURCE_GAGCPPAPI_INCLUDE_COMMON_EVENTHANDLER_H_ */
