/**
 * @file RawPV.h
 * @short contain definition of class \c GaGCppAPI::RawPV
 *
 * Version Information
 * -------------------
 * $Revision: 29111 $
 ...
 *
 */
#ifndef CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_PV_RAWPV_H_
#define CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_PV_RAWPV_H_
// System header
#include <vector>
#include <map>
...
namespace GaGCppAPI {
    ...
    typedef std::map<std::string, std::string> pvPropertyList;
    typedef std::pair<std::string, std::string> pvPropertyListEntry;
    ...
    class RawPV : public EventHandler
    {
        public:
             ...
             * @param _arg2 event argument. is set by fire command.
             */
            virtual void
        ...
        private:
             ...
             * @param _checkConnection when set, the method will check the gamma service connection
             *
             */
            void
            prepareOpen (bool _checkConnection = true);
            ...
            /**
             * @short list of all PV properties
             */
            pvPropertyList mPropertyList;

    };

} /* namespace GaGCppAPI */

#endif /* CHUCKCOOLING_SOURCE_GAGCPPAPI_INCLUDE_PV_RAWPV_H_ */
