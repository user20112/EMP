/**
 * @file BaseTecDriverVersionInfo.h
 * @short contain definition of class \c BaseTecDriver::ModuleVersionInfo
 *
 ...
 *
 */
#ifndef SOURCE_BASETECDRIVER_INCLUDE_APPVERSIONINFO_H_
#define SOURCE_BASETECDRIVER_INCLUDE_APPVERSIONINFO_H_
...
namespace BaseTecDriver {
     ...
     *
     * @remark
     * this class is a singelton class. Use static method \c BaseTecDriver::getInstance() to get access to the
...
#endif /* SOURCE_BASETECDRIVER_INCLUDE_APPVERSIONINFO_H_ */
